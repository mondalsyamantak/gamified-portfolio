const skills = [
  ...
  { name: "NEXT.JS", lv: 62, xp: 62, desc: "* Server-side rendering with Determination." },
  { name: "TAILWINDCSS", lv: 95, xp: 95, desc: "* Trained at building visually appealing interfaces" },
...
export default function SkillsPage() {
  return (
    <div className="flex flex-col gap-1 p-6 pb-20">
      <Typewriter className="text-white text-2xl font-8bit mb-4" speed={40}>* You checked his STATS.</Typewriter>
